...
namespace Tasks
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nЗадание 2.14A");
            string storonap1 = Console.ReadLine();
            string storonap2 = Console.ReadLine();
            double storonaP1 = Convert.ToDouble(storonap1);
            double storonaP2 = Convert.ToDouble(storonap2);
            double PErimetr = 2 * (storonaP1 + storonaP2);
            double Diagonal = Math.Sqrt(storonaP1 * storonaP1 + storonaP2 * storonaP2);
            ...
            string angl =Console.ReadLine();//угол
            double angL = Convert.ToDouble(angl);
            ...
            int Price3c = 3 * (monitorprice + keybprice + blockprice + mouseprice);
            int Price = countcomp * (monitorprice + keybprice + blockprice + mouseprice);
            Console.WriteLine(Price3c);
            ...
            Console.WriteLine("\nЗадание 3.2а")
            int aznach1 = int.Parse(Console.ReadLine());
            int bznach1 = int.Parse(Console.ReadLine());
            int cznach1 = int.Parse(Console.ReadLine());
            int ff = bznach1;
            int gg = cznach1;
            bznach1 = aznach1;
            cznach1 = ff;
            aznach1 = gg;
            Console.WriteLine(aznach1);
            Console.WriteLine(bznach1);
            Console.WriteLine(cznach1);
